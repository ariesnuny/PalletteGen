...
ventana.iconbitmap("py\someColor\PaletteGen.ico")
ventana.resizable(0,0)

#color
fondo1 = Label(ventana, width=40, height=20)
fondo1.pack(pady=5, fill=X)
nombre1 = Button(fondo1, font= ("Comic Sans MS", 10), bg="#CCCCFF", fg="black", relief="flat")
...
nombre2 = Button(fondo2, font= ("Comic Sans MS", 10), bg="#CCCCFF", fg="black", relief="flat")
...
nombre3 = Button(fondo3, font= ("Comic Sans MS", 10), bg="#CCCCFF", fg="black", relief="flat")
...
nombre4 = Button(fondo4, font= ("Comic Sans MS", 10), bg="#CCCCFF", fg="black", relief="flat")
...
nombre5 = Button(fondo5, font= ("Comic Sans MS", 10), bg="#CCCCFF", fg="black", relief="flat")
